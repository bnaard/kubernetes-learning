  ...
  \tcbitem
    \begin{tcbitemize}[
      ...
      \tcbitem
        ...
        \note{Higher-priority pods are scheduled first. If no nodes have capacity, the scheduler \textbf{preempts} (evicts) lower-priority pods to make room. User values: \textbf{0\,--\,1\,000\,000\,000}. Above 1\,B is reserved for \texttt{system-cluster-critical} (2\,B) and \texttt{system-node-critical} (2\,000\,001\,000).}
  ...
  \tcbitem
    \begin{tcbitemize}[
      ...
      \tcbitem
        ...
        "NAME:.metadata.name,CLASS:.status.qosClass" \
        --sort-by=".status.qosClass"  # alphabetical = eviction order
